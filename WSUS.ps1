#Уведомление на почту о статусе обновлений на серверах из WSUS

Param (
[string]$UpdateServer = 'WSUS', # This is the WSUS server name.
...
$smtp = "MAIL.contoso.local" # This is your SMTP Server
$to1 = "Ivan@contoso.ru" # This is the recipient smtp address 1
$to2 = "Petr@contoso.ru" # This is the recipient smtp address 2
$from = $UpdateServer + "<wsus@contoso.ru>" # This will be the sender´s address identifying the WSUS server
